...
mysql_select_db($database_conn, $conn);
$query_bill_set = sprintf("SELECT * FROM own  ,bill WHERE own.ownerID = %s and   bill.houseID =own.houseID  ", GetSQLValueString($totalRows_bill_set, "int"));
...
$totalPages_bill_set = ceil($totalRows_bill_set/$maxRows_bill_set)-1;$maxRows_bill_set = 5;
$pageNum_bill_set = 0;
if (isset($_GET['pageNum_bill_set'])) {
  $pageNum_bill_set = $_GET['pageNum_bill_set'];
}
